  ...
  return (
    <div className="h-screen w-full bg-black flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50">
        <div className="bg-gradient-to-t from-gray-900 via-gray-900/90 to-transparent py-6 px-8">
          <div className="container mx-auto flex justify-between items-center">
            {/* Character class info on the left if selected */}
            {selectedIndex !== null && getSelectedTemplate() && (
              <div className="flex items-center">
                <div className="bg-gray-800/70 px-4 py-2 rounded-lg flex items-center space-x-3">
                  <div className="text-gray-300">
                    <div className="text-xs text-blue-400">Selected Class</div>
                    <div className="font-bold text-white">{getSelectedTemplate()?.class}</div>
                  </div>
                </div>
              </div>
            )}
            ...
            <Button 
              ...
              className={`py-4 px-8 transition-all ${
                selectedIndex !== null 
                  ? 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 shadow-lg border border-blue-400/30' 
                  : 'bg-gray-700'
              }`}
            >
