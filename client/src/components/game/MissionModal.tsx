...
const MissionModal: React.FC<MissionModalProps> = ({ onQuestComplete, onClose, isOpen }) => {
  const {
    getCurrentMission,
    startMission,
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-gray-900 text-white border-gray-800 max-h-[80vh] overflow-y-auto">
        {showQuestDialog ? (
          <StoryQuest
          ...
          <div className="p-1">
              ...
              <div className="mb-4">
                ...
                <Card className="bg-gray-800 p-3 hover:bg-gray-700 transition-colors cursor-pointer" onClick={() => setShowQuestDialog(true)}>
                  ...
                  <div className="mt-2 flex flex-wrap gap-1">
                    {currentMission.storylines.map((storyline: string) => (
                    ...
                    >
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-sm text-gray-400 truncate max-w-xs">{mission.description}</p>
                        </div>
                      </div>
                      <div className="mt-2 flex flex-wrap gap-1">
            ...
            <div className="mt-4 flex justify-end">
              {!currentMission && availableMissions.length > 0 && (
                <Button
